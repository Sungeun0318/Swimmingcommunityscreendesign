    ...
    <div className="bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-card border-b border-gray-200 dark:border-gray-800 z-10 transition-all duration-300">
      <div className="max-w-md mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 dark:from-amber-500 dark:via-yellow-500 dark:to-amber-600 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group">
            <Crown className="w-4 h-4 text-amber-900 dark:text-amber-950 group-hover:rotate-12 transition-transform" />
            <span className="text-amber-900 dark:text-amber-950 font-semibold text-sm">Premium</span>
